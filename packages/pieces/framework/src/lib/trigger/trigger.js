...
var ITrigger = /** @class */ (function () {
    function ITrigger(name, displayName, description, props, type, handshakeConfiguration, onEnable, onHandshake, onDisable, run, test, sampleData, requireAuth) {
...
var createTrigger = function (params) {
    var _a, _b, _c;
    return new ITrigger(params.name, params.displayName, params.description, params.props, params.type, (_a = params.handshakeConfiguration) !== null && _a !== void 0 ? _a : { strategy: WebhookHandshakeStrategy.NONE }, params.onEnable, (_b = params.onHandshake) !== null && _b !== void 0 ? _b : (function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, ({ status: 200 })];
    }); }); }), params.onDisable, params.run, (_c = params.test) !== null && _c !== void 0 ? _c : (function () { return Promise.resolve([params.sampleData]); }), params.sampleData, params.requireAuth);
};
